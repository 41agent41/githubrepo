"""
Technical Indicators Calculator for TradingApp
==============================================

Comprehensive technical analysis indicators using pandas and numpy.
Broker-agnostic - works with any OHLCV market data source.
"""
...
class TechnicalIndicators:
    ...
    def atr(
        ...
        true_range = (
            pd.concat([high_low, high_close_prev, low_close_prev], axis=1).max(axis=1)
        )
...
class IndicatorCalculator:
    ...
    def calculate_indicators(
        self, df: pd.DataFrame, indicator_list: List[str]
    ) -> pd.DataFrame:
        """
